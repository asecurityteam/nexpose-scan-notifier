...
// Source: github.com/asecurityteam/nexpose-scan-notifier/pkg/domain (interfaces: Producer)
...
func (m *MockProducer) Produce(arg0 context.Context, arg1 domain.CompletedScan) error {
	m.ctrl.T.Helper()
